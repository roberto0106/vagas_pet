...
<div class="card-deck">
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title"><a href="/vagas">{{ $vagas->ocorrencias }} Vagas cadastradas.</a></h5>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title"><a href="/candidatos">{{ $candidatos->ocorrencias }} Candidatos cadastrados.</a></h5>
